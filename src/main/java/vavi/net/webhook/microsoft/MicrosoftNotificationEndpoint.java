...
@ServerEndpoint(value = "/ws/microsoft",
                configurator = CustomSpringConfigurator.class)
public class MicrosoftNotificationEndpoint {

    private static final Logger LOG = LoggerFactory.getLogger(MicrosoftNotificationEndpoint.class);

    private WebHookService service;

    @Autowired
    public MicrosoftNotificationEndpoint(WebHookService service) {
